...
PSI 3
Make a class in a separate file with private fields, public getters and setters, a constructor 
  with and without parameters               // SEE SPI3
Overload a method                           // SEE SPI3
Describe inheritance and its benefits       
  // Inheritance- a subclass will inherit the properties, fields and methods, of its parent class
  // when using a subclass that has extra unique properties, inheritance is beneficial
Develop code that makes use of polymorphism        // SEE POLYMORPHISM
Use super and this to access objects and constructors    // SEE SPI3


     // SEE ArrayCrazy for remaining quests. 
...
Effectively utilize exception handling for user input of an int  // SEE GetInput
